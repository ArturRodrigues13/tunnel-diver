...
var _xx = x + sprite_width - 1; // Facilitar leitura
var _yy = y + sprite_height + (distancia * dist); // Atualizada frame por frame para permitir a detecção de colisão e ajuste do sprite correto

if (descendo) { // Movimento interpolado com base na direção
	
	alvo = collision_rectangle(x,_yy,_xx,_yy + 5,o_player,false,false); // Colisão na parte inferior do pistão
